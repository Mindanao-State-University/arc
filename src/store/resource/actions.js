...
export const resourceListReadSuccess = (resource, list, request, thunk, count) => ({
...
export const RESOURCE_LIST_EXPORT_REQUEST = 'RESOURCE_LIST_EXPORT_REQUEST'
export const RESOURCE_LIST_EXPORT_SUCCESS = 'RESOURCE_LIST_EXPORT_SUCCESS'
export const RESOURCE_LIST_EXPORT_FAILURE = 'RESOURCE_LIST_EXPORT_FAILURE'

export const resourceListExportRequest = (resource, params) => ({
  type: RESOURCE_LIST_EXPORT_REQUEST,
  payload: { params },
  meta: {
    resource,
    thunk: `${resource}ListExport`,
  },
})

export const resourceListExportSuccess = (resource, response, request, thunk) => ({
  type: RESOURCE_LIST_EXPORT_SUCCESS,
  payload: response,
  meta: {
    request,
    thunk,
...
export const resourceListExportFailure = (resource, error, request, thunk) => ({
  type: RESOURCE_LIST_EXPORT_FAILURE,
  error: true,
  payload: error,
  meta: {
    request,
